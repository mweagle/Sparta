...
// DocsInstallRequirements installs the desired version of hugo
...
// DocsBuild builds the current documentation in the /docs folder
func DocsBuild() error {
	...
	mg.SerialDeps(cleanDocsDirectory)
...
func DocsCommit() error {
	...
	commitNoMessageScript = append(commitNoMessageScript,
		[]string{"git", "commit", "-m", `"Updated documentation"`},
	)
